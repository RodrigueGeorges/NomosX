/**
 * TEST RAPIDE - Provider IMF SDMX Chainé
 */

import { searchIMFChained } from '../../lib/agent/monitoring-agent.ts';

async function testIMFProvider() {
  console.log('🏦 TEST PROVIDER IMF (SDMX + eLibrary Chain)\n');
  
  try {
    const results = await searchIMFChained('inflation', 5);
