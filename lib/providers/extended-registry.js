...
const {LawZeroProvider} = require('./lawzero-provider.mjs');
...
const {McKinseyGlobalInstituteProvider} = require('./mckinsey-global-institute-provider.mjs');
...
const {RSISProvider} = require('./rsis-provider.mjs');
...
const {WRIProvider} = require('./wri-provider.mjs');

// Data Science
const {PapersWithCodeProvider} = require('./papers-with-code-provider.mjs');
const {KaggleResearchProvider} = require('./kaggle-research-provider.mjs');
const {ArXivCSProvider} = require('./arxiv-cs-provider.js');

// Santé Publique
const {WHOProvider} = require('./who-provider.mjs');
...
const {VanguardProvider} = require('./vanguard-provider.mjs');

// Géopolitique
const {ChathamHouseProvider} = require('./chatham-house-provider.js');
const {RANDProvider} = require('./rand-provider.mjs');
