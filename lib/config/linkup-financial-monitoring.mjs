...
export const LINKUP_FINANCIAL_CONFIG = {
  ...
  queryTemplates: {
    earnings: '{company} Q4 2024 earnings revenue operating income',
    quarterly: '{company} quarterly financial results 2024',
    annual: '{company} annual revenue growth 2024',
    stock: '{company} stock performance analysis 2024',
    market: '{company} market capitalization valuation 2024',
    strategic: '{company} strategic initiatives investments 2024',
    ai: '{company} AI investments revenue impact 2024',
    transformation: '{company} digital transformation ROI 2024'
  },
...
export function generateFinancialQueries(companies = LINKUP_FINANCIAL_CONFIG.companies, timeframe = '2024') {
  const queries = [];
  const templates = LINKUP_FINANCIAL_CONFIG.queryTemplates;
  
  companies.forEach(company => {
    Object.values(templates).forEach(template => {
      const query = template.replace('{company}', company).replace('2024', timeframe);
      queries.push({
        query,
        company,
        timeframe,
