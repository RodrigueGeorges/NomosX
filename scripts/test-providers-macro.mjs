/**
 * TEST SIMPLE PROVIDERS MACRO
 */

import { searchEurostat } from '../lib/providers/macro/eurostat-api.js';
import { searchECB } from '../lib/providers/macro/ecb-api.js';
import { searchINSEE } from '../lib/providers/macro/insee-api.js';
